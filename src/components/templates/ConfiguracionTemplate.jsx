...
import fondocuadros from "../../assets/fondocuadros.svg?url";
...
export function ConfiguracionTemplate() {
  const { mostrarpermisos, idusuario, datausuarios } = useUsuariosStore();
  const { data: datapermisos,isLoading } = useQuery({
