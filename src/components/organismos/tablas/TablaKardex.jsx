...
export function TablaKardex({
  ...
  const { eliminarkardex, kardexItemSelect } = useKardexStore();
  const editar = (data) => {
  ...
  const columns = [
    {
      ...
      cell: (info) => (
        <td data-title="Producto" className="ContentCell">
          <span style={{textDecoration:info.row.original.estado==false?"line-through":""}}>{info.getValue()}</span>
        </td>
      ),
      id: 1,
    },
    {
      accessorKey: "fecha", //nombre columna bd
      header: "Fecha",
      cell: (info) => (
    ...
    {
      accessorKey: "tipo", //nombre columna bd
      header: "Tipo",
      cell: (info) => (
        <td data-title="Tipo" className="ContentCell">
          {info.getValue()?.includes("Salida") ? (
    ...
    {
      accessorKey: "detalle", //nombre columna bd
      header: "Detalle",
      cell: (info) => (
    ...
    {
      accessorKey: "nombres", //nombre columna bd
      header: "Usuario",
      cell: (info) => (
    ...
    {
      accessorKey: "cantidad", //nombre columna bd
      header: "Cantidad",
      cell: (info) => (
    ...
    {
      accessorKey: "stock", //nombre columna bd
      header: "Stock",
      cell: (info) => (
