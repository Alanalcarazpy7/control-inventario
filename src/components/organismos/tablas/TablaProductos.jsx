...
export function TablaProductos({
  ...
  const { eliminarproductos, mostrarproductos } = useProductosStore();
  ...
  const columns = [
    ...
    {
      accessorKey: "precioventa", //nombre columna bd
      header: "P.Venta",
      enableSorting: false,
      cell: (info) => (
    ...
    {
      accessorKey: "preciocompra", //nombre columna bd
      header: "P.Compra",
      enableSorting: false,
      cell: (info) => (
    ...
    {
      accessorKey: "categoria", //nombre columna bd
      header: "Categoria",
      enableSorting: false,
      cell: (info) => (
    ...
    {
      accessorKey: "marca", //nombre columna bd
      header: "Marca",
      enableSorting: false,
      cell: (info) => (
