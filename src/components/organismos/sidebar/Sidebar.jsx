  ...
  return (
    <Main $isopen={state.toString()}>
      ...
      <Container $isopen={state.toString()} className={state ? "active" : ""}>
        ...
        <ToggleTema />
        <Divider />
        {/* Este es el boton de cerrar sesion,el sidecard,si el state es true,osea esta activo el sidebar,tambien muestra el sidecard */}
        {state && <SidebarCard />}
      </Container>
    </Main>
  );
...
const Main = styled.div`
  .Sidebarbutton {
    ...
    cursor: pointer;
    transition: all 0.2s;
    /*sirve para el icono que abre el sidebar,se desplaze y gire*/
    transform: ${({ $isopen }) =>
